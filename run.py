...
query_open_button = tkinter.Button(master, text='结果查询(参数化建模)', width=30, height=3, font=40, command=query_window)
query_open_button.grid(row=1, column=0)
cal_open_button = tkinter.Button(master, text='流体传热仿真', width=30, height=3, font=40, command=cal_window)
